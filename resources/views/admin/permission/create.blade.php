                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/permission') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="icon">上级 * :</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="icon" placeholder="图标" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <input class="form-control" type="text" name="sort" placeholder="排序" value="{{ old('sort') ?: 1 }}" />
                                </div>
                            </div>
                            <div class="form-group">
